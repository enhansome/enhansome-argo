...
* [Argo Helm](https://github.com/argoproj/argo-helm) ⭐ 2,368 | 🐛 41 | 🌐 Mustache | 📅 2026-09-19 is a collection of community-maintained Helm charts for Argo projects.
...
* [Argo CD Vault Plugin](https://github.com/argoproj-labs/argocd-vault-plugin) ⭐ 978 | 🐛 162 | 🌐 Go | 📅 2024-12-18 is an Argo CD plugin to retrieve secrets from Secret Management tools and inject them into Kubernetes resources.
* [Hera](https://github.com/argoproj-labs/hera) ⭐ 938 | 🐛 31 | 🌐 Python | 📅 2026-09-19 is an Argo Python SDK. Hera aims to make construction and submission of various Argo Project resources easy and accessible to everyone.
* [Argo CD Operator](https://github.com/argoproj-labs/argocd-operator) ⭐ 889 | 🐛 78 | 🌐 Go | 📅 2026-09-18 is a Kubernetes operator for managing Argo CD clusters.
* [Argo CD Agent](https://github.com/argoproj-labs/argocd-agent) ⭐ 593 | 🐛 61 | 🌐 Go | 📅 2026-09-18 aims to improve scalability and security of Argo CD's multi-cluster capabilities
...
* [Meshery](https://github.com/meshery/meshery) ⭐ 11,834 | 🐛 2,021 | 🌐 TypeScript | 📅 2026-09-20 is the open source, cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
...
* [Reloader](https://github.com/stakater/Reloader) ⭐ 10,420 | 🐛 165 | 🌐 Go | 📅 2026-09-18 is a Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on associated Deployments/StatefulSets/Daemonsets and Argo Rollouts.
* [Metaflow](https://github.com/Netflix/metaflow) ⭐ 10,274 | 🐛 503 | 🌐 Python | 📅 2026-09-14 is a Python library for building and managing real-life data science projects.
* [Devtron](https://github.com/devtron-labs/devtron) ⭐ 5,602 | 🐛 771 | 🌐 Go | 📅 2026-09-17 is a Web-Based CI/CD Platform for Kubernetes, powered by Argo.
...
* [Kubeflow Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,222 | 🐛 504 | 🌐 Go | 📅 2026-09-20 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
...
* [Kargo](https://github.com/akuity/kargo) ⭐ 3,668 | 🐛 215 | 🌐 Go | 📅 2026-09-20 helps GitOps practitioners streamline continuous delivery for Kubernetes by automating the progression of changes from one environment to the next.
...
* [Kubeflow Katib](https://github.com/kubeflow/katib) ⭐ 1,703 | 🐛 118 | 🌐 Python | 📅 2026-09-20 is a Kubernetes-native project for automated machine learning (AutoML).
...
* [kubechecks](https://github.com/zapier/kubechecks) ⭐ 612 | 🐛 13 | 🌐 Go | 📅 2026-09-19 is a tool to check what changes a pull-request will make to your ArgoCD applications, with reporting directly in the PR.
* [terraform-provider-argocd](https://github.com/oboukili/terraform-provider-argocd) ⭐ 508 | 🐛 37 | 🌐 Go | 📅 2026-09-20 is the Terraform provider for Argo CD.
* [argocd-lovely-plugin](https://github.com/crumbhole/argocd-lovely-plugin) ⭐ 490 | 🐛 12 | 🌐 Go | 📅 2026-09-19 is a plugin that allows you to composite multiple things together into a single argocd application or applicationSet. Includes allowing Helm+Kustomize, addition other manifests trivially and running additional plugins in a pipe.
...
* [argonaut](https://github.com/darksworm/argonaut) ⭐ 454 | 🐛 12 | 🌐 Go | 📅 2026-09-08 is a TUI application for managing apps in Argo CD with real-time monitoring, diff viewing, and sync/rollback operations.
* [Nixidy](https://github.com/arnarg/nixidy) ⭐ 387 | 🐛 3 | 🌐 Nix | 📅 2026-09-07 is a tool to apply the rendered manifest pattern using NixOS-like modules to define Argo CD applications.
...
* [active-monitor](https://github.com/keikoproj/active-monitor) ⭐ 188 | 🐛 20 | 🌐 Go | 📅 2026-09-20 is a Kubernetes controller which enables deep cluster monitoring and self-healing using Argo Workflows.
* [argocd-commenter](https://github.com/int128/argocd-commenter) ⭐ 154 | 🐛 13 | 🌐 Go | 📅 2026-09-19 is a Kubernetes controller to notify a change of Argo CD Application status via comments on GitHub pull requests and GitHub Deployments.
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 137 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-20 is an AI-powered multi-cluster Kubernetes management dashboard (CNCF Sandbox) that integrates with Argo CD for GitOps-driven workload placement and monitoring across edge and cloud clusters.
...
* [provider-argocd](https://github.com/crossplane-contrib/provider-argocd) ⭐ 99 | 🐛 11 | 🌐 Go | 📅 2026-09-20 is the Crossplane infrastructure provider for Argo CD.
...
* [argocd-gitops-updater-action](https://github.com/drumandbytes/argocd-gitops-updater-action) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-09-20 is a GitHub Action that bumps Helm chart and container image versions in GitOps repos, with Argo CD and Kustomize auto-discovery, semver bumps and Slack/Teams/Discord/Telegram notifications.
...
* [Argo CD](https://github.com/argoproj/argo-cd/blob/master/README.md#blogs-and-presentations) ⭐ 24,204 | 🐛 4,359 | 🌐 Go | 📅 2026-09-20
* [Argo Workflows](https://github.com/argoproj/argo-workflows/blob/master/README.md#community-blogs-and-presentations) ⭐ 16,994 | 🐛 1,288 | 🌐 Go | 📅 2026-09-20
* [Argo Rollouts](https://github.com/argoproj/argo-rollouts/blob/master/README.md#community-blogs-and-presentations) ⭐ 3,588 | 🐛 651 | 🌐 Go | 📅 2026-09-18
* [Argo Events](https://github.com/argoproj/argo-events/blob/master/README.md#blogs-and-presentations) ⭐ 2,694 | 🐛 147 | 🌐 Go | 📅 2026-09-20
