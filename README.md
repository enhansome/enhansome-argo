...
* [Argo Helm](https://github.com/argoproj/argo-helm) ⭐ 2,364 | 🐛 37 | 🌐 Mustache | 📅 2026-09-07 is a collection of community-maintained Helm charts for Argo projects.
* [Argo CD Image Updater](https://github.com/argoproj-labs/argocd-image-updater) ⭐ 1,717 | 🐛 313 | 🌐 Go | 📅 2026-09-03 is a tool to automatically update the container images of Kubernetes workloads which are managed by Argo CD.
* [Argo CD Autopilot](https://github.com/argoproj-labs/argocd-autopilot) ⭐ 1,127 | 🐛 96 | 🌐 Go | 📅 2025-12-16 offers an opinionated way of installing Argo CD and managing GitOps repositories.
* [Argo CD Vault Plugin](https://github.com/argoproj-labs/argocd-vault-plugin) ⭐ 976 | 🐛 162 | 🌐 Go | 📅 2024-12-18 is an Argo CD plugin to retrieve secrets from Secret Management tools and inject them into Kubernetes resources.
* [Hera](https://github.com/argoproj-labs/hera) ⭐ 937 | 🐛 31 | 🌐 Python | 📅 2026-09-07 is an Argo Python SDK. Hera aims to make construction and submission of various Argo Project resources easy and accessible to everyone.
* [Argo CD Operator](https://github.com/argoproj-labs/argocd-operator) ⭐ 883 | 🐛 72 | 🌐 Go | 📅 2026-09-07 is a Kubernetes operator for managing Argo CD clusters.
* [Argo CD Agent](https://github.com/argoproj-labs/argocd-agent) ⭐ 587 | 🐛 63 | 🌐 Go | 📅 2026-09-01 aims to improve scalability and security of Argo CD's multi-cluster capabilities
* [Notifications Engine](https://github.com/argoproj/notifications-engine) ⭐ 334 | 🐛 115 | 🌐 Go | 📅 2026-06-23 is a configuration-driven Golang library that provides notifications for cloud-native applications.
* [Argo Rollout Extension](https://github.com/argoproj-labs/rollout-extension) ⭐ 288 | 🐛 36 | 🌐 TypeScript | 📅 2026-06-30 contains the Argo Rollout dashboard that can be added into the Argo CD Web UI.
* [Argo Rollouts Manager](https://github.com/argoproj-labs/argo-rollouts-manager) ⭐ 143 | 🐛 2 | 🌐 Go | 📅 2026-08-26 is a Kubernetes operator that provides an easy way to install, upgrade and manage the lifecycle of Argo Rollouts.
* [Argo CD Extensions](https://github.com/argoproj-labs/argocd-extensions) ⭐ 116 | 🐛 18 | 🌐 Go | 📅 2023-11-17 enables extensions for Argo CD.
* [Argo CD RBAC Operator](https://github.com/argoproj-labs/argocd-rbac-operator) ⭐ 110 | 🐛 23 | 🌐 Go | 📅 2026-02-20 is a Kubernetes operator for managing Argo CD's RBAC. It supports both global scoped RBAC (`argocd-rbac-cm`) and project scoped RBAC (AppProjects).
* [Argo Workflows Catalog](https://github.com/argoproj-labs/argo-workflows-catalog) ⭐ 107 | 🐛 8 | 🌐 Go | 📅 2026-04-28 contains free reusable templates for Argo Workflows.
* [Argo CD Interlace](https://github.com/argoproj-labs/argocd-interlace) ⭐ 95 | 🐛 2 | 🌐 Go | 📅 2022-11-04 is a Kubernetes controller to enable software supply chain security capabilities in Argo CD.
...
* [Meshery](https://github.com/meshery/meshery) ⭐ 11,723 | 🐛 1,936 | 🌐 TypeScript | 📅 2026-09-07 is the open source, cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
* [Kedro](https://github.com/quantumblacklabs/kedro) ⭐ 10,990 | 🐛 139 | 🌐 Python | 📅 2026-09-07 is an open-source Python framework for creating reproducible, maintainable and modular data science code.
* [Reloader](https://github.com/stakater/Reloader) ⭐ 10,390 | 🐛 162 | 🌐 Go | 📅 2026-09-07 is a Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on associated Deployments/StatefulSets/Daemonsets and Argo Rollouts.
* [Metaflow](https://github.com/Netflix/metaflow) ⭐ 10,257 | 🐛 495 | 🌐 Python | 📅 2026-09-02 is a Python library for building and managing real-life data science projects.
* [Devtron](https://github.com/devtron-labs/devtron) ⭐ 5,591 | 🐛 769 | 🌐 Go | 📅 2026-09-07 is a Web-Based CI/CD Platform for Kubernetes, powered by Argo.
...
* [Kubeflow Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,207 | 🐛 475 | 🌐 Go | 📅 2026-09-07 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
...
* [Kargo](https://github.com/akuity/kargo) ⭐ 3,636 | 🐛 183 | 🌐 Go | 📅 2026-09-07 helps GitOps practitioners streamline continuous delivery for Kubernetes by automating the progression of changes from one environment to the next.
...
* [kubefirst](https://github.com/kubefirst/kubefirst/) ⭐ 2,058 | 🐛 289 | 🌐 Go | 📅 2026-02-25 provides fully automated open source application delivery and infrastructure management GitOps platforms for Kubernetes.
* [Kubeflow Katib](https://github.com/kubeflow/katib) ⭐ 1,698 | 🐛 115 | 🌐 Python | 📅 2026-09-07 is a Kubernetes-native project for automated machine learning (AutoML).
...
* [Onepanel](https://github.com/onepanelio/onepanel) ⭐ 732 | 🐛 102 | 🌐 Go | 📅 2023-02-25 is the open source, end-to-end computer vision platform.
* [kubechecks](https://github.com/zapier/kubechecks) ⭐ 612 | 🐛 14 | 🌐 Go | 📅 2026-09-02 is a tool to check what changes a pull-request will make to your ArgoCD applications, with reporting directly in the PR.
* [terraform-provider-argocd](https://github.com/oboukili/terraform-provider-argocd) ⭐ 508 | 🐛 36 | 🌐 Go | 📅 2026-09-07 is the Terraform provider for Argo CD.
* [argocd-lovely-plugin](https://github.com/crumbhole/argocd-lovely-plugin) ⭐ 490 | 🐛 15 | 🌐 Go | 📅 2026-09-07 is a plugin that allows you to composite multiple things together into a single argocd application or applicationSet. Includes allowing Helm+Kustomize, addition other manifests trivially and running additional plugins in a pipe.
* [deployKF](https://github.com/deployKF/deployKF) ⭐ 466 | 🐛 65 | 🌐 Shell | 📅 2024-08-03 effortlessly integrates Kubeflow, and leading MLOps tools on Kubernetes into open ML platforms (uses Argo CD and Argo Workflows).
* [argonaut](https://github.com/darksworm/argonaut) ⭐ 445 | 🐛 12 | 🌐 Go | 📅 2026-09-07 is a TUI application for managing apps in Argo CD with real-time monitoring, diff viewing, and sync/rollback operations.
* [Nixidy](https://github.com/arnarg/nixidy) ⭐ 384 | 🐛 3 | 🌐 Nix | 📅 2026-09-07 is a tool to apply the rendered manifest pattern using NixOS-like modules to define Argo CD applications.
...
* [active-monitor](https://github.com/keikoproj/active-monitor) ⭐ 187 | 🐛 26 | 🌐 Go | 📅 2026-09-02 is a Kubernetes controller which enables deep cluster monitoring and self-healing using Argo Workflows.
* [argocd-commenter](https://github.com/int128/argocd-commenter) ⭐ 155 | 🐛 13 | 🌐 Go | 📅 2026-09-05 is a Kubernetes controller to notify a change of Argo CD Application status via comments on GitHub pull requests and GitHub Deployments.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 132 | 🐛 166 | 🌐 TypeScript | 📅 2026-09-07 is an AI-powered multi-cluster Kubernetes management dashboard (CNCF Sandbox) that integrates with Argo CD for GitOps-driven workload placement and monitoring across edge and cloud clusters.
...
* [argocd-trivy-extension](https://github.com/mziyabo/argocd-trivy-extension) ⭐ 109 | 🐛 7 | 🌐 JavaScript | 📅 2025-09-07 is Argo CD extension to enable visualization of Trivy generated vulnerability reports in Argo CD UI.
...
* [argo-watcher](https://github.com/shini4i/argo-watcher) ⭐ 107 | 🐛 2 | 🌐 Go | 📅 2026-09-07 is a small service that improves the visibility of deployments that are using Argo CD Image Updater.
* [argo-cd-action](https://github.com/clowdhaus/argo-cd-action) ⭐ 100 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-31 is a GitHub Action for executing Argo CD.
* [provider-argocd](https://github.com/crossplane-contrib/provider-argocd) ⭐ 99 | 🐛 20 | 🌐 Go | 📅 2026-08-24 is the Crossplane infrastructure provider for Argo CD.
* [ci-github-notifiter](https://github.com/sendible-labs/ci-github-notifier) ⭐ 52 | 🐛 9 | 🌐 Go | 📅 2026-09-02 is a lightweight container to post Argo Workflow statuses back to GitHub as [Status Checks](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/collaborating-on-repositories-with-code-quality-features/about-status-checks).
* [argo-compare](https://github.com/shini4i/argo-compare) ⭐ 44 | 🐛 1 | 🌐 Go | 📅 2026-09-05 is a small CLI tool showing the difference in the resulting helm manifests rendered from Applications in different git branches.
* [Piper](https://github.com/quickube/piper) ⭐ 35 | 🐛 15 | 🌐 Go | 📅 2025-02-12 is a Kubernetes controller which enables managing multi-branch pipelines for Argo Workflows to shift left pipeline configuraiton.
* [argocd-nutshell](https://github.com/jannfis/argocd-nutshell) ⭐ 32 | 🐛 0 | 📅 2023-09-12 is a set of scripts to set up repeatable, zero-conf demo and test environments for Argo CD using Vagrant, Ansible and VirtualBox
* [argopm](https://github.com/atlanhq/argopm) ⭐ 24 | 🐛 26 | 🌐 JavaScript | 📅 2026-08-28 is a package manager for Argo Workflows. It enables developers to distribute and consume argo workflow templates as reusable modules.
* [argo-trivy-insights](https://github.com/DeWildeDaan/Argo-Trivy-Insights) ⭐ 18 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-07 is a Argo CD extension to view and analyze Trivy vulnerability findings for individual Argo CD applications or across your entire GitOps fleet.
* [Juno](https://github.com/lumindigital/juno) ⭐ 12 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-31 is an Argo Workflows Generator written in Typescript. Juno helps take the pain out of writing workflows in YAML
* [argocd-gitops-updater-action](https://github.com/drumandbytes/argocd-gitops-updater-action) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-09-06 is a GitHub Action that bumps Helm chart and container image versions in GitOps repos, with Argo CD and Kustomize auto-discovery, semver bumps and Slack/Teams/Discord/Telegram notifications.
...
* [Argo Workflows Guide in Chinese](https://github.com/LinuxSuRen/argo-workflows-guide) ⭐ 8 | 🐛 0 | 🌐 Dockerfile | 📅 2025-05-14
...
* [Unveil The Secret Ingredients for Argo CD in the Enterprise-Scale](https://github.com/terrytangyuan/public-talks/tree/main/talks/unveil-the-secret-ingredients-for-argo-cd-at-enterprise-scale-kubecon-china-2021) ⭐ 34 | 🐛 0 | 🌐 Python | 📅 2026-09-01
...
* [Argo Project GitHub Organization](https://github.com/argoproj) ([Maintainers](https://github.com/argoproj/argoproj/blob/master/MAINTAINERS.md) ⭐ 754 | 🐛 28 | 🌐 Python | 📅 2026-09-04 and [Community Governance](https://github.com/argoproj/argoproj/blob/master/community/GOVERNANCE.md) ⭐ 754 | 🐛 28 | 🌐 Python | 📅 2026-09-04)
...
* Argo Project User Survey Results:
  * [2021](https://github.com/argoproj/argoproj/blob/f4daa47706c73302faba1608cbc312bbafa0abfc/community/user_surveys/Argo%20CD%20and%20Rollouts%20User%20Survey%202021.pdf) ⭐ 754 | 🐛 28 | 🌐 Python | 📅 2026-09-04
  * [2020](https://github.com/argoproj/argoproj/blob/f4daa47706c73302faba1608cbc312bbafa0abfc/community/user_surveys/ArgoWorkflows2020SurveySummary.pdf) ⭐ 754 | 🐛 28 | 🌐 Python | 📅 2026-09-04
...
Some blogposts and videos are selected from [Argo's community blogs and presentations](https://github.com/argoproj/argoproj#community-blogs-and-presentations) ⭐ 754 | 🐛 28 | 🌐 Python | 📅 2026-09-04.

Thanks to the contributors who've submitted pull requests to add the original references to the following locations:

* [Argo CD](https://github.com/argoproj/argo-cd/blob/master/README.md#blogs-and-presentations) ⭐ 24,097 | 🐛 4,366 | 🌐 Go | 📅 2026-09-07
* [Argo Workflows](https://github.com/argoproj/argo-workflows/blob/master/README.md#community-blogs-and-presentations) ⭐ 16,959 | 🐛 1,274 | 🌐 Go | 📅 2026-09-07
* [Argo Rollouts](https://github.com/argoproj/argo-rollouts/blob/master/README.md#community-blogs-and-presentations) ⭐ 3,572 | 🐛 660 | 🌐 Go | 📅 2026-09-07
* [Argo Events](https://github.com/argoproj/argo-events/blob/master/README.md#blogs-and-presentations) ⭐ 2,689 | 🐛 151 | 🌐 Go | 📅 2026-09-05
