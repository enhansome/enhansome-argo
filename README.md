...
* [Argo Helm](https://github.com/argoproj/argo-helm) ⭐ 2,356 | 🐛 73 | 🌐 Mustache | 📅 2026-08-24 is a collection of community-maintained Helm charts for Argo projects.
...
* [Argo CD Operator](https://github.com/argoproj-labs/argocd-operator) ⭐ 880 | 🐛 58 | 🌐 Go | 📅 2026-08-25 is a Kubernetes operator for managing Argo CD clusters.
* [Argo CD Agent](https://github.com/argoproj-labs/argocd-agent) ⭐ 579 | 🐛 61 | 🌐 Go | 📅 2026-08-25 aims to improve scalability and security of Argo CD's multi-cluster capabilities
* [Notifications Engine](https://github.com/argoproj/notifications-engine) ⭐ 333 | 🐛 114 | 🌐 Go | 📅 2026-06-23 is a configuration-driven Golang library that provides notifications for cloud-native applications.
...
* [Meshery](https://github.com/meshery/meshery) ⭐ 11,571 | 🐛 1,830 | 🌐 TypeScript | 📅 2026-08-25 is the open source, cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
...
* [Reloader](https://github.com/stakater/Reloader) ⭐ 10,363 | 🐛 164 | 🌐 Go | 📅 2026-08-23 is a Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on associated Deployments/StatefulSets/Daemonsets and Argo Rollouts.
* [Metaflow](https://github.com/Netflix/metaflow) ⭐ 10,240 | 🐛 484 | 🌐 Python | 📅 2026-08-21 is a Python library for building and managing real-life data science projects.
* [Devtron](https://github.com/devtron-labs/devtron) ⭐ 5,589 | 🐛 765 | 🌐 Go | 📅 2026-08-24 is a Web-Based CI/CD Platform for Kubernetes, powered by Argo.
...
* [Kubeflow Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,193 | 🐛 463 | 🌐 Python | 📅 2026-08-24 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
...
* [Kargo](https://github.com/akuity/kargo) ⭐ 3,599 | 🐛 173 | 🌐 Go | 📅 2026-08-25 helps GitOps practitioners streamline continuous delivery for Kubernetes by automating the progression of changes from one environment to the next.
...
* [terraform-provider-argocd](https://github.com/oboukili/terraform-provider-argocd) ⭐ 508 | 🐛 34 | 🌐 Go | 📅 2026-08-25 is the Terraform provider for Argo CD.
...
* [Argo CD](https://github.com/argoproj/argo-cd/blob/master/README.md#blogs-and-presentations) ⭐ 23,992 | 🐛 4,395 | 🌐 Go | 📅 2026-08-25
* [Argo Workflows](https://github.com/argoproj/argo-workflows/blob/master/README.md#community-blogs-and-presentations) ⭐ 16,936 | 🐛 1,265 | 🌐 Go | 📅 2026-08-25
* [Argo Rollouts](https://github.com/argoproj/argo-rollouts/blob/master/README.md#community-blogs-and-presentations) ⭐ 3,561 | 🐛 659 | 🌐 Go | 📅 2026-08-25
