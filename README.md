...
* [Argo Helm](https://github.com/argoproj/argo-helm) ⭐ 2,347 | 🐛 62 | 🌐 Mustache | 📅 2026-08-14 is a collection of community-maintained Helm charts for Argo projects.
* [Argo CD Image Updater](https://github.com/argoproj-labs/argocd-image-updater) ⭐ 1,706 | 🐛 314 | 🌐 Go | 📅 2026-08-13 is a tool to automatically update the container images of Kubernetes workloads which are managed by Argo CD.
* [Argo CD Autopilot](https://github.com/argoproj-labs/argocd-autopilot) ⭐ 1,127 | 🐛 97 | 🌐 Go | 📅 2025-12-16 offers an opinionated way of installing Argo CD and managing GitOps repositories.
* [Argo CD Vault Plugin](https://github.com/argoproj-labs/argocd-vault-plugin) ⭐ 973 | 🐛 162 | 🌐 Go | 📅 2024-12-18 is an Argo CD plugin to retrieve secrets from Secret Management tools and inject them into Kubernetes resources.
* [Hera](https://github.com/argoproj-labs/hera) ⭐ 927 | 🐛 26 | 🌐 Python | 📅 2026-08-09 is an Argo Python SDK. Hera aims to make construction and submission of various Argo Project resources easy and accessible to everyone.
* [Argo CD Operator](https://github.com/argoproj-labs/argocd-operator) ⭐ 881 | 🐛 57 | 🌐 Go | 📅 2026-08-14 is a Kubernetes operator for managing Argo CD clusters.
* [Argo CD Agent](https://github.com/argoproj-labs/argocd-agent) ⭐ 572 | 🐛 59 | 🌐 Go | 📅 2026-08-13 aims to improve scalability and security of Argo CD's multi-cluster capabilities
* [Notifications Engine](https://github.com/argoproj/notifications-engine) ⭐ 332 | 🐛 112 | 🌐 Go | 📅 2026-06-23 is a configuration-driven Golang library that provides notifications for cloud-native applications.
* [Argo Rollout Extension](https://github.com/argoproj-labs/rollout-extension) ⭐ 287 | 🐛 35 | 🌐 TypeScript | 📅 2026-06-30 contains the Argo Rollout dashboard that can be added into the Argo CD Web UI.
* [Argo Rollouts Manager](https://github.com/argoproj-labs/argo-rollouts-manager) ⭐ 143 | 🐛 5 | 🌐 Go | 📅 2026-08-13 is a Kubernetes operator that provides an easy way to install, upgrade and manage the lifecycle of Argo Rollouts.
* [Argo CD Extensions](https://github.com/argoproj-labs/argocd-extensions) ⭐ 116 | 🐛 18 | 🌐 Go | 📅 2023-11-17 enables extensions for Argo CD.
* [Argo CD RBAC Operator](https://github.com/argoproj-labs/argocd-rbac-operator) ⭐ 109 | 🐛 19 | 🌐 Go | 📅 2026-02-20 is a Kubernetes operator for managing Argo CD's RBAC. It supports both global scoped RBAC (`argocd-rbac-cm`) and project scoped RBAC (AppProjects).
...
* [Argo CD Interlace](https://github.com/argoproj-labs/argocd-interlace) ⭐ 93 | 🐛 2 | 🌐 Go | 📅 2022-11-04 is a Kubernetes controller to enable software supply chain security capabilities in Argo CD.
...
* [Meshery](https://github.com/meshery/meshery) ⭐ 11,484 | 🐛 1,793 | 🌐 TypeScript | 📅 2026-08-14 is the open source, cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
* [Kedro](https://github.com/quantumblacklabs/kedro) ⭐ 10,952 | 🐛 152 | 🌐 Python | 📅 2026-08-14 is an open-source Python framework for creating reproducible, maintainable and modular data science code.
* [Reloader](https://github.com/stakater/Reloader) ⭐ 10,327 | 🐛 163 | 🌐 Go | 📅 2026-08-10 is a Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on associated Deployments/StatefulSets/Daemonsets and Argo Rollouts.
* [Metaflow](https://github.com/Netflix/metaflow) ⭐ 10,213 | 🐛 481 | 🌐 Python | 📅 2026-08-13 is a Python library for building and managing real-life data science projects.
* [Devtron](https://github.com/devtron-labs/devtron) ⭐ 5,578 | 🐛 762 | 🌐 Go | 📅 2026-08-14 is a Web-Based CI/CD Platform for Kubernetes, powered by Argo.
...
* [Kubeflow Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,182 | 🐛 477 | 🌐 Python | 📅 2026-08-14 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
...
* [Kargo](https://github.com/akuity/kargo) ⭐ 3,571 | 🐛 175 | 🌐 Go | 📅 2026-08-14 helps GitOps practitioners streamline continuous delivery for Kubernetes by automating the progression of changes from one environment to the next.
* [kubefirst](https://github.com/kubefirst/kubefirst/) ⭐ 2,056 | 🐛 289 | 🌐 Go | 📅 2026-02-25 provides fully automated open source application delivery and infrastructure management GitOps platforms for Kubernetes.
* [Kubeflow Katib](https://github.com/kubeflow/katib) ⭐ 1,694 | 🐛 106 | 🌐 Python | 📅 2026-08-06 is a Kubernetes-native project for automated machine learning (AutoML).
...
* [kubechecks](https://github.com/zapier/kubechecks) ⭐ 604 | 🐛 14 | 🌐 Go | 📅 2026-08-10 is a tool to check what changes a pull-request will make to your ArgoCD applications, with reporting directly in the PR.
* [terraform-provider-argocd](https://github.com/oboukili/terraform-provider-argocd) ⭐ 507 | 🐛 49 | 🌐 Go | 📅 2026-08-13 is the Terraform provider for Argo CD.
* [argocd-lovely-plugin](https://github.com/crumbhole/argocd-lovely-plugin) ⭐ 490 | 🐛 18 | 🌐 Go | 📅 2026-08-14 is a plugin that allows you to composite multiple things together into a single argocd application or applicationSet. Includes allowing Helm+Kustomize, addition other manifests trivially and running additional plugins in a pipe.
...
* [argonaut](https://github.com/darksworm/argonaut) ⭐ 436 | 🐛 8 | 🌐 Go | 📅 2026-08-09 is a TUI application for managing apps in Argo CD with real-time monitoring, diff viewing, and sync/rollback operations.
* [Nixidy](https://github.com/arnarg/nixidy) ⭐ 373 | 🐛 2 | 🌐 Nix | 📅 2026-08-14 is a tool to apply the rendered manifest pattern using NixOS-like modules to define Argo CD applications.
...
* [k8s-bootstrapper](https://github.com/hivenetes/k8s-bootstrapper) ⭐ 281 | 🐛 4 | 🌐 HCL | 📅 2024-10-04 is a framework to set up production ready Kubernetes clusters using Terraform and Argo CD.
* [active-monitor](https://github.com/keikoproj/active-monitor) ⭐ 187 | 🐛 32 | 🌐 Go | 📅 2026-08-01 is a Kubernetes controller which enables deep cluster monitoring and self-healing using Argo Workflows.
* [argocd-commenter](https://github.com/int128/argocd-commenter) ⭐ 154 | 🐛 13 | 🌐 Go | 📅 2026-08-08 is a Kubernetes controller to notify a change of Argo CD Application status via comments on GitHub pull requests and GitHub Deployments.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 127 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-14 is an AI-powered multi-cluster Kubernetes management dashboard (CNCF Sandbox) that integrates with Argo CD for GitOps-driven workload placement and monitoring across edge and cloud clusters.
...
* [argocd-trivy-extension](https://github.com/mziyabo/argocd-trivy-extension) ⭐ 108 | 🐛 7 | 🌐 JavaScript | 📅 2025-09-07 is Argo CD extension to enable visualization of Trivy generated vulnerability reports in Argo CD UI.
* [argo-watcher](https://github.com/shini4i/argo-watcher) ⭐ 105 | 🐛 2 | 🌐 Go | 📅 2026-08-12 is a small service that improves the visibility of deployments that are using Argo CD Image Updater.
* [argo-cd-action](https://github.com/clowdhaus/argo-cd-action) ⭐ 99 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-10 is a GitHub Action for executing Argo CD.
* [provider-argocd](https://github.com/crossplane-contrib/provider-argocd) ⭐ 99 | 🐛 23 | 🌐 Go | 📅 2026-06-18 is the Crossplane infrastructure provider for Argo CD.
* [argo-cd-mixin](https://github.com/adinhodovic/argo-cd-mixin) ⭐ 98 | 🐛 1 | 🌐 Jsonnet | 📅 2026-03-23 is a monitoring mixin for ArgoCD. A set of Grafana dashboards and Prometheus rules for ArgoCD.
* [ci-github-notifiter](https://github.com/sendible-labs/ci-github-notifier) ⭐ 51 | 🐛 9 | 🌐 Go | 📅 2026-08-14 is a lightweight container to post Argo Workflow statuses back to GitHub as [Status Checks](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/collaborating-on-repositories-with-code-quality-features/about-status-checks).
* [argo-compare](https://github.com/shini4i/argo-compare) ⭐ 43 | 🐛 1 | 🌐 Go | 📅 2026-07-23 is a small CLI tool showing the difference in the resulting helm manifests rendered from Applications in different git branches.
...
* [argocd-nutshell](https://github.com/jannfis/argocd-nutshell) ⭐ 31 | 🐛 0 | 📅 2023-09-12 is a set of scripts to set up repeatable, zero-conf demo and test environments for Argo CD using Vagrant, Ansible and VirtualBox
* [argopm](https://github.com/atlanhq/argopm) ⭐ 24 | 🐛 25 | 🌐 JavaScript | 📅 2026-05-29 is a package manager for Argo Workflows. It enables developers to distribute and consume argo workflow templates as reusable modules.
* [Juno](https://github.com/lumindigital/juno) ⭐ 12 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-06 is an Argo Workflows Generator written in Typescript. Juno helps take the pain out of writing workflows in YAML
* [argo-trivy-insights](https://github.com/DeWildeDaan/Argo-Trivy-Insights) ⭐ 2 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-10 is a Argo CD extension to view and analyze Trivy vulnerability findings for individual Argo CD applications or across your entire GitOps fleet.
...
* [Unveil The Secret Ingredients for Argo CD in the Enterprise-Scale](https://github.com/terrytangyuan/public-talks/tree/main/talks/unveil-the-secret-ingredients-for-argo-cd-at-enterprise-scale-kubecon-china-2021) ⭐ 35 | 🐛 0 | 🌐 Python | 📅 2026-08-12
...
* [Argo Project GitHub Organization](https://github.com/argoproj) ([Maintainers](https://github.com/argoproj/argoproj/blob/master/MAINTAINERS.md) ⭐ 756 | 🐛 25 | 🌐 Python | 📅 2026-07-17 and [Community Governance](https://github.com/argoproj/argoproj/blob/master/community/GOVERNANCE.md) ⭐ 756 | 🐛 25 | 🌐 Python | 📅 2026-07-17)
...
* Argo Project User Survey Results:
  * [2021](https://github.com/argoproj/argoproj/blob/f4daa47706c73302faba1608cbc312bbafa0abfc/community/user_surveys/Argo%20CD%20and%20Rollouts%20User%20Survey%202021.pdf) ⭐ 756 | 🐛 25 | 🌐 Python | 📅 2026-07-17
  * [2020](https://github.com/argoproj/argoproj/blob/f4daa47706c73302faba1608cbc312bbafa0abfc/community/user_surveys/ArgoWorkflows2020SurveySummary.pdf) ⭐ 756 | 🐛 25 | 🌐 Python | 📅 2026-07-17
...
Some blogposts and videos are selected from [Argo's community blogs and presentations](https://github.com/argoproj/argoproj#community-blogs-and-presentations) ⭐ 756 | 🐛 25 | 🌐 Python | 📅 2026-07-17.

Thanks to the contributors who've submitted pull requests to add the original references to the following locations:

* [Argo CD](https://github.com/argoproj/argo-cd/blob/master/README.md#blogs-and-presentations) ⭐ 23,921 | 🐛 4,360 | 🌐 Go | 📅 2026-08-14
* [Argo Workflows](https://github.com/argoproj/argo-workflows/blob/master/README.md#community-blogs-and-presentations) ⭐ 16,900 | 🐛 1,251 | 🌐 Go | 📅 2026-08-14
* [Argo Rollouts](https://github.com/argoproj/argo-rollouts/blob/master/README.md#community-blogs-and-presentations) ⭐ 3,553 | 🐛 657 | 🌐 Go | 📅 2026-08-14
* [Argo Events](https://github.com/argoproj/argo-events/blob/master/README.md#blogs-and-presentations) ⭐ 2,685 | 🐛 154 | 🌐 Go | 📅 2026-08-08
