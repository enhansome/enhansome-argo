...
* [Argo Helm](https://github.com/argoproj/argo-helm) ⭐ 2,367 | 🐛 37 | 🌐 Mustache | 📅 2026-09-18 is a collection of community-maintained Helm charts for Argo projects.
* [Argo CD Image Updater](https://github.com/argoproj-labs/argocd-image-updater) ⭐ 1,716 | 🐛 322 | 🌐 Go | 📅 2026-09-17 is a tool to automatically update the container images of Kubernetes workloads which are managed by Argo CD.
...
* [Argo CD Operator](https://github.com/argoproj-labs/argocd-operator) ⭐ 889 | 🐛 79 | 🌐 Go | 📅 2026-09-18 is a Kubernetes operator for managing Argo CD clusters.
* [Argo CD Agent](https://github.com/argoproj-labs/argocd-agent) ⭐ 591 | 🐛 62 | 🌐 Go | 📅 2026-09-18 aims to improve scalability and security of Argo CD's multi-cluster capabilities
...
* [Meshery](https://github.com/meshery/meshery) ⭐ 11,820 | 🐛 2,016 | 🌐 TypeScript | 📅 2026-09-18 is the open source, cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
...
* [Reloader](https://github.com/stakater/Reloader) ⭐ 10,417 | 🐛 166 | 🌐 Go | 📅 2026-09-18 is a Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on associated Deployments/StatefulSets/Daemonsets and Argo Rollouts.
* [Metaflow](https://github.com/Netflix/metaflow) ⭐ 10,273 | 🐛 502 | 🌐 Python | 📅 2026-09-14 is a Python library for building and managing real-life data science projects.
...
* [Kubeflow Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,221 | 🐛 502 | 🌐 Go | 📅 2026-09-17 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
...
* [Kargo](https://github.com/akuity/kargo) ⭐ 3,665 | 🐛 214 | 🌐 Go | 📅 2026-09-18 helps GitOps practitioners streamline continuous delivery for Kubernetes by automating the progression of changes from one environment to the next.
...
* [Kubeflow Katib](https://github.com/kubeflow/katib) ⭐ 1,703 | 🐛 120 | 🌐 Python | 📅 2026-09-14 is a Kubernetes-native project for automated machine learning (AutoML).
...
* [terraform-provider-argocd](https://github.com/oboukili/terraform-provider-argocd) ⭐ 506 | 🐛 37 | 🌐 Go | 📅 2026-09-17 is the Terraform provider for Argo CD.
* [argocd-lovely-plugin](https://github.com/crumbhole/argocd-lovely-plugin) ⭐ 489 | 🐛 12 | 🌐 Go | 📅 2026-09-18 is a plugin that allows you to composite multiple things together into a single argocd application or applicationSet. Includes allowing Helm+Kustomize, addition other manifests trivially and running additional plugins in a pipe.
...
* [argonaut](https://github.com/darksworm/argonaut) ⭐ 452 | 🐛 12 | 🌐 Go | 📅 2026-09-08 is a TUI application for managing apps in Argo CD with real-time monitoring, diff viewing, and sync/rollback operations.
...
* [active-monitor](https://github.com/keikoproj/active-monitor) ⭐ 188 | 🐛 24 | 🌐 Go | 📅 2026-09-18 is a Kubernetes controller which enables deep cluster monitoring and self-healing using Argo Workflows.
* [argocd-commenter](https://github.com/int128/argocd-commenter) ⭐ 154 | 🐛 13 | 🌐 Go | 📅 2026-09-18 is a Kubernetes controller to notify a change of Argo CD Application status via comments on GitHub pull requests and GitHub Deployments.
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 137 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-18 is an AI-powered multi-cluster Kubernetes management dashboard (CNCF Sandbox) that integrates with Argo CD for GitOps-driven workload placement and monitoring across edge and cloud clusters.
...
* [provider-argocd](https://github.com/crossplane-contrib/provider-argocd) ⭐ 99 | 🐛 11 | 🌐 Go | 📅 2026-09-18 is the Crossplane infrastructure provider for Argo CD.
...
* [argo-trivy-insights](https://github.com/DeWildeDaan/Argo-Trivy-Insights) ⭐ 19 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-14 is a Argo CD extension to view and analyze Trivy vulnerability findings for individual Argo CD applications or across your entire GitOps fleet.
...
* [Argo CD](https://github.com/argoproj/argo-cd/blob/master/README.md#blogs-and-presentations) ⭐ 24,183 | 🐛 4,363 | 🌐 Go | 📅 2026-09-18
* [Argo Workflows](https://github.com/argoproj/argo-workflows/blob/master/README.md#community-blogs-and-presentations) ⭐ 16,987 | 🐛 1,290 | 🌐 Go | 📅 2026-09-18
* [Argo Rollouts](https://github.com/argoproj/argo-rollouts/blob/master/README.md#community-blogs-and-presentations) ⭐ 3,585 | 🐛 650 | 🌐 Go | 📅 2026-09-18
