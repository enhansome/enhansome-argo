...
* [Argo Helm](https://github.com/argoproj/argo-helm) ⭐ 2,345 | 🐛 60 | 🌐 Mustache | 📅 2026-08-13 is a collection of community-maintained Helm charts for Argo projects.
* [Argo CD Image Updater](https://github.com/argoproj-labs/argocd-image-updater) ⭐ 1,706 | 🐛 311 | 🌐 Go | 📅 2026-08-13 is a tool to automatically update the container images of Kubernetes workloads which are managed by Argo CD.
...
* [Hera](https://github.com/argoproj-labs/hera) ⭐ 926 | 🐛 26 | 🌐 Python | 📅 2026-08-09 is an Argo Python SDK. Hera aims to make construction and submission of various Argo Project resources easy and accessible to everyone.
* [Argo CD Operator](https://github.com/argoproj-labs/argocd-operator) ⭐ 880 | 🐛 55 | 🌐 Go | 📅 2026-08-13 is a Kubernetes operator for managing Argo CD clusters.
* [Argo CD Agent](https://github.com/argoproj-labs/argocd-agent) ⭐ 570 | 🐛 57 | 🌐 Go | 📅 2026-08-12 aims to improve scalability and security of Argo CD's multi-cluster capabilities
...
* [Meshery](https://github.com/meshery/meshery) ⭐ 11,478 | 🐛 1,800 | 🌐 TypeScript | 📅 2026-08-13 is the open source, cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
...
* [Reloader](https://github.com/stakater/Reloader) ⭐ 10,323 | 🐛 163 | 🌐 Go | 📅 2026-08-10 is a Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on associated Deployments/StatefulSets/Daemonsets and Argo Rollouts.
* [Metaflow](https://github.com/Netflix/metaflow) ⭐ 10,210 | 🐛 479 | 🌐 Python | 📅 2026-08-12 is a Python library for building and managing real-life data science projects.
* [Devtron](https://github.com/devtron-labs/devtron) ⭐ 5,575 | 🐛 762 | 🌐 Go | 📅 2026-08-12 is a Web-Based CI/CD Platform for Kubernetes, powered by Argo.
...
* [Kubeflow Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,181 | 🐛 493 | 🌐 Python | 📅 2026-08-13 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
...
* [Kargo](https://github.com/akuity/kargo) ⭐ 3,568 | 🐛 176 | 🌐 Go | 📅 2026-08-13 helps GitOps practitioners streamline continuous delivery for Kubernetes by automating the progression of changes from one environment to the next.
* [kubefirst](https://github.com/kubefirst/kubefirst/) ⭐ 2,055 | 🐛 289 | 🌐 Go | 📅 2026-02-25 provides fully automated open source application delivery and infrastructure management GitOps platforms for Kubernetes.
...
* [terraform-provider-argocd](https://github.com/oboukili/terraform-provider-argocd) ⭐ 506 | 🐛 48 | 🌐 Go | 📅 2026-08-13 is the Terraform provider for Argo CD.
* [argocd-lovely-plugin](https://github.com/crumbhole/argocd-lovely-plugin) ⭐ 490 | 🐛 17 | 🌐 Go | 📅 2026-08-13 is a plugin that allows you to composite multiple things together into a single argocd application or applicationSet. Includes allowing Helm+Kustomize, addition other manifests trivially and running additional plugins in a pipe.
...
* [argonaut](https://github.com/darksworm/argonaut) ⭐ 435 | 🐛 7 | 🌐 Go | 📅 2026-08-09 is a TUI application for managing apps in Argo CD with real-time monitoring, diff viewing, and sync/rollback operations.
* [Nixidy](https://github.com/arnarg/nixidy) ⭐ 373 | 🐛 2 | 🌐 Nix | 📅 2026-08-12 is a tool to apply the rendered manifest pattern using NixOS-like modules to define Argo CD applications.
...
* [active-monitor](https://github.com/keikoproj/active-monitor) ⭐ 186 | 🐛 32 | 🌐 Go | 📅 2026-08-01 is a Kubernetes controller which enables deep cluster monitoring and self-healing using Argo Workflows.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 127 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-13 is an AI-powered multi-cluster Kubernetes management dashboard (CNCF Sandbox) that integrates with Argo CD for GitOps-driven workload placement and monitoring across edge and cloud clusters.
...
* [provider-argocd](https://github.com/crossplane-contrib/provider-argocd) ⭐ 99 | 🐛 21 | 🌐 Go | 📅 2026-06-18 is the Crossplane infrastructure provider for Argo CD.
...
* [ci-github-notifiter](https://github.com/sendible-labs/ci-github-notifier) ⭐ 51 | 🐛 9 | 🌐 Go | 📅 2026-08-13 is a lightweight container to post Argo Workflow statuses back to GitHub as [Status Checks](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/collaborating-on-repositories-with-code-quality-features/about-status-checks).
* [argo-compare](https://github.com/shini4i/argo-compare) ⭐ 42 | 🐛 1 | 🌐 Go | 📅 2026-07-23 is a small CLI tool showing the difference in the resulting helm manifests rendered from Applications in different git branches.
...
* [Argo CD](https://github.com/argoproj/argo-cd/blob/master/README.md#blogs-and-presentations) ⭐ 23,917 | 🐛 4,349 | 🌐 Go | 📅 2026-08-13
* [Argo Workflows](https://github.com/argoproj/argo-workflows/blob/master/README.md#community-blogs-and-presentations) ⭐ 16,896 | 🐛 1,259 | 🌐 Go | 📅 2026-08-13
* [Argo Rollouts](https://github.com/argoproj/argo-rollouts/blob/master/README.md#community-blogs-and-presentations) ⭐ 3,551 | 🐛 657 | 🌐 Go | 📅 2026-08-11
