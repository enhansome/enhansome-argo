...
* [Argo Helm](https://github.com/argoproj/argo-helm) ⭐ 2,352 | 🐛 60 | 🌐 Mustache | 📅 2026-08-17 is a collection of community-maintained Helm charts for Argo projects.
* [Argo CD Image Updater](https://github.com/argoproj-labs/argocd-image-updater) ⭐ 1,708 | 🐛 314 | 🌐 Go | 📅 2026-08-13 is a tool to automatically update the container images of Kubernetes workloads which are managed by Argo CD.
...
* [Argo CD Operator](https://github.com/argoproj-labs/argocd-operator) ⭐ 882 | 🐛 58 | 🌐 Go | 📅 2026-08-17 is a Kubernetes operator for managing Argo CD clusters.
* [Argo CD Agent](https://github.com/argoproj-labs/argocd-agent) ⭐ 574 | 🐛 59 | 🌐 Go | 📅 2026-08-13 aims to improve scalability and security of Argo CD's multi-cluster capabilities
...
* [Meshery](https://github.com/meshery/meshery) ⭐ 11,492 | 🐛 1,783 | 🌐 TypeScript | 📅 2026-08-17 is the open source, cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
...
* [Reloader](https://github.com/stakater/Reloader) ⭐ 10,337 | 🐛 163 | 🌐 Go | 📅 2026-08-17 is a Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on associated Deployments/StatefulSets/Daemonsets and Argo Rollouts.
* [Metaflow](https://github.com/Netflix/metaflow) ⭐ 10,222 | 🐛 480 | 🌐 Python | 📅 2026-08-15 is a Python library for building and managing real-life data science projects.
...
* [Kubeflow Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,185 | 🐛 465 | 🌐 Python | 📅 2026-08-17 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
...
* [Kargo](https://github.com/akuity/kargo) ⭐ 3,574 | 🐛 171 | 🌐 Go | 📅 2026-08-17 helps GitOps practitioners streamline continuous delivery for Kubernetes by automating the progression of changes from one environment to the next.
...
* [argocd-lovely-plugin](https://github.com/crumbhole/argocd-lovely-plugin) ⭐ 490 | 🐛 18 | 🌐 Go | 📅 2026-08-17 is a plugin that allows you to composite multiple things together into a single argocd application or applicationSet. Includes allowing Helm+Kustomize, addition other manifests trivially and running additional plugins in a pipe.
...
* [argonaut](https://github.com/darksworm/argonaut) ⭐ 438 | 🐛 9 | 🌐 Go | 📅 2026-08-17 is a TUI application for managing apps in Argo CD with real-time monitoring, diff viewing, and sync/rollback operations.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 128 | 🐛 43 | 🌐 TypeScript | 📅 2026-08-17 is an AI-powered multi-cluster Kubernetes management dashboard (CNCF Sandbox) that integrates with Argo CD for GitOps-driven workload placement and monitoring across edge and cloud clusters.
...
* [argo-watcher](https://github.com/shini4i/argo-watcher) ⭐ 105 | 🐛 3 | 🌐 Go | 📅 2026-08-17 is a small service that improves the visibility of deployments that are using Argo CD Image Updater.
...
* [Argo CD](https://github.com/argoproj/argo-cd/blob/master/README.md#blogs-and-presentations) ⭐ 23,934 | 🐛 4,354 | 🌐 Go | 📅 2026-08-17
* [Argo Workflows](https://github.com/argoproj/argo-workflows/blob/master/README.md#community-blogs-and-presentations) ⭐ 16,906 | 🐛 1,259 | 🌐 Go | 📅 2026-08-17
* [Argo Rollouts](https://github.com/argoproj/argo-rollouts/blob/master/README.md#community-blogs-and-presentations) ⭐ 3,555 | 🐛 657 | 🌐 Go | 📅 2026-08-17
* [Argo Events](https://github.com/argoproj/argo-events/blob/master/README.md#blogs-and-presentations) ⭐ 2,686 | 🐛 155 | 🌐 Go | 📅 2026-08-15
