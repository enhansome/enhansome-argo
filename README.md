...
* [Argo Helm](https://github.com/argoproj/argo-helm) ⭐ 2,367 | 🐛 36 | 🌐 Mustache | 📅 2026-09-12 is a collection of community-maintained Helm charts for Argo projects.
* [Argo CD Image Updater](https://github.com/argoproj-labs/argocd-image-updater) ⭐ 1,717 | 🐛 314 | 🌐 Go | 📅 2026-09-09 is a tool to automatically update the container images of Kubernetes workloads which are managed by Argo CD.
* [Argo CD Autopilot](https://github.com/argoproj-labs/argocd-autopilot) ⭐ 1,128 | 🐛 96 | 🌐 Go | 📅 2025-12-16 offers an opinionated way of installing Argo CD and managing GitOps repositories.
* [Argo CD Vault Plugin](https://github.com/argoproj-labs/argocd-vault-plugin) ⭐ 977 | 🐛 162 | 🌐 Go | 📅 2024-12-18 is an Argo CD plugin to retrieve secrets from Secret Management tools and inject them into Kubernetes resources.
* [Hera](https://github.com/argoproj-labs/hera) ⭐ 939 | 🐛 29 | 🌐 Python | 📅 2026-09-08 is an Argo Python SDK. Hera aims to make construction and submission of various Argo Project resources easy and accessible to everyone.
* [Argo CD Operator](https://github.com/argoproj-labs/argocd-operator) ⭐ 889 | 🐛 78 | 🌐 Go | 📅 2026-09-11 is a Kubernetes operator for managing Argo CD clusters.
* [Argo CD Agent](https://github.com/argoproj-labs/argocd-agent) ⭐ 590 | 🐛 66 | 🌐 Go | 📅 2026-09-10 aims to improve scalability and security of Argo CD's multi-cluster capabilities
* [Notifications Engine](https://github.com/argoproj/notifications-engine) ⭐ 334 | 🐛 117 | 🌐 Go | 📅 2026-06-23 is a configuration-driven Golang library that provides notifications for cloud-native applications.
* [Argo Rollout Extension](https://github.com/argoproj-labs/rollout-extension) ⭐ 289 | 🐛 36 | 🌐 TypeScript | 📅 2026-06-30 contains the Argo Rollout dashboard that can be added into the Argo CD Web UI.
* [Argo Rollouts Manager](https://github.com/argoproj-labs/argo-rollouts-manager) ⭐ 142 | 🐛 2 | 🌐 Go | 📅 2026-08-26 is a Kubernetes operator that provides an easy way to install, upgrade and manage the lifecycle of Argo Rollouts.
...
* [Meshery](https://github.com/meshery/meshery) ⭐ 11,778 | 🐛 1,980 | 🌐 TypeScript | 📅 2026-09-13 is the open source, cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
...
* [Reloader](https://github.com/stakater/Reloader) ⭐ 10,407 | 🐛 161 | 🌐 Go | 📅 2026-09-09 is a Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on associated Deployments/StatefulSets/Daemonsets and Argo Rollouts.
* [Metaflow](https://github.com/Netflix/metaflow) ⭐ 10,263 | 🐛 499 | 🌐 Python | 📅 2026-09-13 is a Python library for building and managing real-life data science projects.
* [Devtron](https://github.com/devtron-labs/devtron) ⭐ 5,596 | 🐛 777 | 🌐 Go | 📅 2026-09-12 is a Web-Based CI/CD Platform for Kubernetes, powered by Argo.
...
* [Kubeflow Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,211 | 🐛 496 | 🌐 Go | 📅 2026-09-13 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
...
* [Kargo](https://github.com/akuity/kargo) ⭐ 3,652 | 🐛 209 | 🌐 Go | 📅 2026-09-13 helps GitOps practitioners streamline continuous delivery for Kubernetes by automating the progression of changes from one environment to the next.
...
* [Kubeflow Katib](https://github.com/kubeflow/katib) ⭐ 1,699 | 🐛 119 | 🌐 Python | 📅 2026-09-10 is a Kubernetes-native project for automated machine learning (AutoML).
...
* [Onepanel](https://github.com/onepanelio/onepanel) ⭐ 732 | 🐛 101 | 🌐 Go | 📅 2023-02-25 is the open source, end-to-end computer vision platform.
* [kubechecks](https://github.com/zapier/kubechecks) ⭐ 612 | 🐛 16 | 🌐 Go | 📅 2026-09-08 is a tool to check what changes a pull-request will make to your ArgoCD applications, with reporting directly in the PR.
* [terraform-provider-argocd](https://github.com/oboukili/terraform-provider-argocd) ⭐ 508 | 🐛 36 | 🌐 Go | 📅 2026-09-13 is the Terraform provider for Argo CD.
* [argocd-lovely-plugin](https://github.com/crumbhole/argocd-lovely-plugin) ⭐ 491 | 🐛 14 | 🌐 Go | 📅 2026-09-13 is a plugin that allows you to composite multiple things together into a single argocd application or applicationSet. Includes allowing Helm+Kustomize, addition other manifests trivially and running additional plugins in a pipe.
...
* [argonaut](https://github.com/darksworm/argonaut) ⭐ 448 | 🐛 11 | 🌐 Go | 📅 2026-09-08 is a TUI application for managing apps in Argo CD with real-time monitoring, diff viewing, and sync/rollback operations.
* [Nixidy](https://github.com/arnarg/nixidy) ⭐ 385 | 🐛 3 | 🌐 Nix | 📅 2026-09-07 is a tool to apply the rendered manifest pattern using NixOS-like modules to define Argo CD applications.
...
* [active-monitor](https://github.com/keikoproj/active-monitor) ⭐ 187 | 🐛 24 | 🌐 Go | 📅 2026-09-10 is a Kubernetes controller which enables deep cluster monitoring and self-healing using Argo Workflows.
* [argocd-commenter](https://github.com/int128/argocd-commenter) ⭐ 155 | 🐛 13 | 🌐 Go | 📅 2026-09-12 is a Kubernetes controller to notify a change of Argo CD Application status via comments on GitHub pull requests and GitHub Deployments.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 135 | 🐛 141 | 🌐 TypeScript | 📅 2026-09-13 is an AI-powered multi-cluster Kubernetes management dashboard (CNCF Sandbox) that integrates with Argo CD for GitOps-driven workload placement and monitoring across edge and cloud clusters.
...
* [argo-watcher](https://github.com/shini4i/argo-watcher) ⭐ 108 | 🐛 2 | 🌐 Go | 📅 2026-09-11 is a small service that improves the visibility of deployments that are using Argo CD Image Updater.
...
* [provider-argocd](https://github.com/crossplane-contrib/provider-argocd) ⭐ 99 | 🐛 21 | 🌐 Go | 📅 2026-09-11 is the Crossplane infrastructure provider for Argo CD.
...
* [argo-compare](https://github.com/shini4i/argo-compare) ⭐ 44 | 🐛 3 | 🌐 Go | 📅 2026-09-10 is a small CLI tool showing the difference in the resulting helm manifests rendered from Applications in different git branches.
...
* [Argo Project GitHub Organization](https://github.com/argoproj) ([Maintainers](https://github.com/argoproj/argoproj/blob/master/MAINTAINERS.md) ⭐ 755 | 🐛 16 | 🌐 Python | 📅 2026-09-11 and [Community Governance](https://github.com/argoproj/argoproj/blob/master/community/GOVERNANCE.md) ⭐ 755 | 🐛 16 | 🌐 Python | 📅 2026-09-11)
...
* Argo Project User Survey Results:
  * [2021](https://github.com/argoproj/argoproj/blob/f4daa47706c73302faba1608cbc312bbafa0abfc/community/user_surveys/Argo%20CD%20and%20Rollouts%20User%20Survey%202021.pdf) ⭐ 755 | 🐛 16 | 🌐 Python | 📅 2026-09-11
  * [2020](https://github.com/argoproj/argoproj/blob/f4daa47706c73302faba1608cbc312bbafa0abfc/community/user_surveys/ArgoWorkflows2020SurveySummary.pdf) ⭐ 755 | 🐛 16 | 🌐 Python | 📅 2026-09-11
...
Some blogposts and videos are selected from [Argo's community blogs and presentations](https://github.com/argoproj/argoproj#community-blogs-and-presentations) ⭐ 755 | 🐛 16 | 🌐 Python | 📅 2026-09-11.

Thanks to the contributors who've submitted pull requests to add the original references to the following locations:

* [Argo CD](https://github.com/argoproj/argo-cd/blob/master/README.md#blogs-and-presentations) ⭐ 24,150 | 🐛 4,362 | 🌐 Go | 📅 2026-09-13
* [Argo Workflows](https://github.com/argoproj/argo-workflows/blob/master/README.md#community-blogs-and-presentations) ⭐ 16,971 | 🐛 1,287 | 🌐 Go | 📅 2026-09-13
* [Argo Rollouts](https://github.com/argoproj/argo-rollouts/blob/master/README.md#community-blogs-and-presentations) ⭐ 3,576 | 🐛 653 | 🌐 Go | 📅 2026-09-11
* [Argo Events](https://github.com/argoproj/argo-events/blob/master/README.md#blogs-and-presentations) ⭐ 2,691 | 🐛 154 | 🌐 Go | 📅 2026-09-12
