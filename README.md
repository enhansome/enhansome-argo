...
* [Argo Helm](https://github.com/argoproj/argo-helm) ⭐ 2,364 | 🐛 39 | 🌐 Mustache | 📅 2026-09-07 is a collection of community-maintained Helm charts for Argo projects.
* [Argo CD Image Updater](https://github.com/argoproj-labs/argocd-image-updater) ⭐ 1,717 | 🐛 311 | 🌐 Go | 📅 2026-09-08 is a tool to automatically update the container images of Kubernetes workloads which are managed by Argo CD.
...
* [Hera](https://github.com/argoproj-labs/hera) ⭐ 937 | 🐛 29 | 🌐 Python | 📅 2026-09-08 is an Argo Python SDK. Hera aims to make construction and submission of various Argo Project resources easy and accessible to everyone.
* [Argo CD Operator](https://github.com/argoproj-labs/argocd-operator) ⭐ 886 | 🐛 74 | 🌐 Go | 📅 2026-09-08 is a Kubernetes operator for managing Argo CD clusters.
* [Argo CD Agent](https://github.com/argoproj-labs/argocd-agent) ⭐ 587 | 🐛 63 | 🌐 Go | 📅 2026-09-08 aims to improve scalability and security of Argo CD's multi-cluster capabilities
...
* [Meshery](https://github.com/meshery/meshery) ⭐ 11,731 | 🐛 1,943 | 🌐 TypeScript | 📅 2026-09-08 is the open source, cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
...
* [Reloader](https://github.com/stakater/Reloader) ⭐ 10,393 | 🐛 162 | 🌐 Go | 📅 2026-09-07 is a Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on associated Deployments/StatefulSets/Daemonsets and Argo Rollouts.
* [Metaflow](https://github.com/Netflix/metaflow) ⭐ 10,258 | 🐛 495 | 🌐 Python | 📅 2026-09-02 is a Python library for building and managing real-life data science projects.
* [Devtron](https://github.com/devtron-labs/devtron) ⭐ 5,591 | 🐛 770 | 🌐 Go | 📅 2026-09-07 is a Web-Based CI/CD Platform for Kubernetes, powered by Argo.
...
* [Kubeflow Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,208 | 🐛 472 | 🌐 Go | 📅 2026-09-08 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
...
* [Kargo](https://github.com/akuity/kargo) ⭐ 3,639 | 🐛 189 | 🌐 Go | 📅 2026-09-08 helps GitOps practitioners streamline continuous delivery for Kubernetes by automating the progression of changes from one environment to the next.
...
* [terraform-provider-argocd](https://github.com/oboukili/terraform-provider-argocd) ⭐ 508 | 🐛 36 | 🌐 Go | 📅 2026-09-08 is the Terraform provider for Argo CD.
...
* [active-monitor](https://github.com/keikoproj/active-monitor) ⭐ 187 | 🐛 25 | 🌐 Go | 📅 2026-09-08 is a Kubernetes controller which enables deep cluster monitoring and self-healing using Argo Workflows.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 133 | 🐛 159 | 🌐 TypeScript | 📅 2026-09-08 is an AI-powered multi-cluster Kubernetes management dashboard (CNCF Sandbox) that integrates with Argo CD for GitOps-driven workload placement and monitoring across edge and cloud clusters.
...
* [argo-watcher](https://github.com/shini4i/argo-watcher) ⭐ 107 | 🐛 3 | 🌐 Go | 📅 2026-09-08 is a small service that improves the visibility of deployments that are using Argo CD Image Updater.
...
* [provider-argocd](https://github.com/crossplane-contrib/provider-argocd) ⭐ 99 | 🐛 19 | 🌐 Go | 📅 2026-09-08 is the Crossplane infrastructure provider for Argo CD.
...
* [Argo Project GitHub Organization](https://github.com/argoproj) ([Maintainers](https://github.com/argoproj/argoproj/blob/master/MAINTAINERS.md) ⭐ 754 | 🐛 16 | 🌐 Python | 📅 2026-09-08 and [Community Governance](https://github.com/argoproj/argoproj/blob/master/community/GOVERNANCE.md) ⭐ 754 | 🐛 16 | 🌐 Python | 📅 2026-09-08)
...
* Argo Project User Survey Results:
  * [2021](https://github.com/argoproj/argoproj/blob/f4daa47706c73302faba1608cbc312bbafa0abfc/community/user_surveys/Argo%20CD%20and%20Rollouts%20User%20Survey%202021.pdf) ⭐ 754 | 🐛 16 | 🌐 Python | 📅 2026-09-08
  * [2020](https://github.com/argoproj/argoproj/blob/f4daa47706c73302faba1608cbc312bbafa0abfc/community/user_surveys/ArgoWorkflows2020SurveySummary.pdf) ⭐ 754 | 🐛 16 | 🌐 Python | 📅 2026-09-08
...
Some blogposts and videos are selected from [Argo's community blogs and presentations](https://github.com/argoproj/argoproj#community-blogs-and-presentations) ⭐ 754 | 🐛 16 | 🌐 Python | 📅 2026-09-08.

Thanks to the contributors who've submitted pull requests to add the original references to the following locations:

* [Argo CD](https://github.com/argoproj/argo-cd/blob/master/README.md#blogs-and-presentations) ⭐ 24,110 | 🐛 4,356 | 🌐 Go | 📅 2026-09-08
* [Argo Workflows](https://github.com/argoproj/argo-workflows/blob/master/README.md#community-blogs-and-presentations) ⭐ 16,961 | 🐛 1,281 | 🌐 Go | 📅 2026-09-08
* [Argo Rollouts](https://github.com/argoproj/argo-rollouts/blob/master/README.md#community-blogs-and-presentations) ⭐ 3,573 | 🐛 660 | 🌐 Go | 📅 2026-09-08
