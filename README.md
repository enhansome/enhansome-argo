...
* [Argo Helm](https://github.com/argoproj/argo-helm) ⭐ 2,353 | 🐛 69 | 🌐 Mustache | 📅 2026-08-22 is a collection of community-maintained Helm charts for Argo projects.
...
* [Hera](https://github.com/argoproj-labs/hera) ⭐ 930 | 🐛 26 | 🌐 Python | 📅 2026-08-18 is an Argo Python SDK. Hera aims to make construction and submission of various Argo Project resources easy and accessible to everyone.
...
* [Meshery](https://github.com/meshery/meshery) ⭐ 11,554 | 🐛 1,820 | 🌐 TypeScript | 📅 2026-08-23 is the open source, cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
...
* [Reloader](https://github.com/stakater/Reloader) ⭐ 10,352 | 🐛 164 | 🌐 Go | 📅 2026-08-23 is a Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on associated Deployments/StatefulSets/Daemonsets and Argo Rollouts.
* [Metaflow](https://github.com/Netflix/metaflow) ⭐ 10,232 | 🐛 482 | 🌐 Python | 📅 2026-08-21 is a Python library for building and managing real-life data science projects.
* [Devtron](https://github.com/devtron-labs/devtron) ⭐ 5,586 | 🐛 764 | 🌐 Go | 📅 2026-08-21 is a Web-Based CI/CD Platform for Kubernetes, powered by Argo.
...
* [Kubeflow Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,192 | 🐛 482 | 🌐 Python | 📅 2026-08-23 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
...
* [Kargo](https://github.com/akuity/kargo) ⭐ 3,589 | 🐛 181 | 🌐 Go | 📅 2026-08-23 helps GitOps practitioners streamline continuous delivery for Kubernetes by automating the progression of changes from one environment to the next.
...
* [terraform-provider-argocd](https://github.com/oboukili/terraform-provider-argocd) ⭐ 508 | 🐛 40 | 🌐 Go | 📅 2026-08-23 is the Terraform provider for Argo CD.
* [argocd-lovely-plugin](https://github.com/crumbhole/argocd-lovely-plugin) ⭐ 490 | 🐛 13 | 🌐 Go | 📅 2026-08-22 is a plugin that allows you to composite multiple things together into a single argocd application or applicationSet. Includes allowing Helm+Kustomize, addition other manifests trivially and running additional plugins in a pipe.
...
* [Nixidy](https://github.com/arnarg/nixidy) ⭐ 381 | 🐛 2 | 🌐 Nix | 📅 2026-08-14 is a tool to apply the rendered manifest pattern using NixOS-like modules to define Argo CD applications.
...
* [argocd-commenter](https://github.com/int128/argocd-commenter) ⭐ 154 | 🐛 14 | 🌐 Go | 📅 2026-08-23 is a Kubernetes controller to notify a change of Argo CD Application status via comments on GitHub pull requests and GitHub Deployments.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 127 | 🐛 35 | 🌐 TypeScript | 📅 2026-08-23 is an AI-powered multi-cluster Kubernetes management dashboard (CNCF Sandbox) that integrates with Argo CD for GitOps-driven workload placement and monitoring across edge and cloud clusters.
...
* [argo-cd-mixin](https://github.com/adinhodovic/argo-cd-mixin) ⭐ 106 | 🐛 0 | 🌐 Jsonnet | 📅 2026-08-16 is a monitoring mixin for ArgoCD. A set of Grafana dashboards and Prometheus rules for ArgoCD.
* [argo-watcher](https://github.com/shini4i/argo-watcher) ⭐ 106 | 🐛 2 | 🌐 Go | 📅 2026-08-23 is a small service that improves the visibility of deployments that are using Argo CD Image Updater.
...
* [Argo CD](https://github.com/argoproj/argo-cd/blob/master/README.md#blogs-and-presentations) ⭐ 23,977 | 🐛 4,388 | 🌐 Go | 📅 2026-08-23
* [Argo Workflows](https://github.com/argoproj/argo-workflows/blob/master/README.md#community-blogs-and-presentations) ⭐ 16,928 | 🐛 1,267 | 🌐 Go | 📅 2026-08-21
