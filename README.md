...
* [Argo Helm](https://github.com/argoproj/argo-helm) ⭐ 2,366 | 🐛 36 | 🌐 Mustache | 📅 2026-09-12 is a collection of community-maintained Helm charts for Argo projects.
...
* [Argo CD Operator](https://github.com/argoproj-labs/argocd-operator) ⭐ 887 | 🐛 78 | 🌐 Go | 📅 2026-09-11 is a Kubernetes operator for managing Argo CD clusters.
* [Argo CD Agent](https://github.com/argoproj-labs/argocd-agent) ⭐ 590 | 🐛 65 | 🌐 Go | 📅 2026-09-10 aims to improve scalability and security of Argo CD's multi-cluster capabilities
...
* [Meshery](https://github.com/meshery/meshery) ⭐ 11,765 | 🐛 1,979 | 🌐 TypeScript | 📅 2026-09-12 is the open source, cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
...
* [Reloader](https://github.com/stakater/Reloader) ⭐ 10,404 | 🐛 161 | 🌐 Go | 📅 2026-09-09 is a Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on associated Deployments/StatefulSets/Daemonsets and Argo Rollouts.
* [Metaflow](https://github.com/Netflix/metaflow) ⭐ 10,263 | 🐛 494 | 🌐 Python | 📅 2026-09-08 is a Python library for building and managing real-life data science projects.
...
* [Kubeflow Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,211 | 🐛 487 | 🌐 Go | 📅 2026-09-10 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
...
* [Kargo](https://github.com/akuity/kargo) ⭐ 3,652 | 🐛 206 | 🌐 Go | 📅 2026-09-11 helps GitOps practitioners streamline continuous delivery for Kubernetes by automating the progression of changes from one environment to the next.
...
* [Kubeflow Katib](https://github.com/kubeflow/katib) ⭐ 1,699 | 🐛 117 | 🌐 Python | 📅 2026-09-10 is a Kubernetes-native project for automated machine learning (AutoML).
...
* [terraform-provider-argocd](https://github.com/oboukili/terraform-provider-argocd) ⭐ 508 | 🐛 36 | 🌐 Go | 📅 2026-09-12 is the Terraform provider for Argo CD.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 134 | 🐛 142 | 🌐 TypeScript | 📅 2026-09-12 is an AI-powered multi-cluster Kubernetes management dashboard (CNCF Sandbox) that integrates with Argo CD for GitOps-driven workload placement and monitoring across edge and cloud clusters.
...
* [provider-argocd](https://github.com/crossplane-contrib/provider-argocd) ⭐ 99 | 🐛 20 | 🌐 Go | 📅 2026-09-11 is the Crossplane infrastructure provider for Argo CD.
...
* [Argo CD](https://github.com/argoproj/argo-cd/blob/master/README.md#blogs-and-presentations) ⭐ 24,143 | 🐛 4,359 | 🌐 Go | 📅 2026-09-12
* [Argo Workflows](https://github.com/argoproj/argo-workflows/blob/master/README.md#community-blogs-and-presentations) ⭐ 16,970 | 🐛 1,288 | 🌐 Go | 📅 2026-09-11
