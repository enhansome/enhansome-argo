...
* [Argo Helm](https://github.com/argoproj/argo-helm) ⭐ 2,367 | 🐛 41 | 🌐 Mustache | 📅 2026-09-19 is a collection of community-maintained Helm charts for Argo projects.
...
* [Hera](https://github.com/argoproj-labs/hera) ⭐ 938 | 🐛 30 | 🌐 Python | 📅 2026-09-19 is an Argo Python SDK. Hera aims to make construction and submission of various Argo Project resources easy and accessible to everyone.
...
* [Meshery](https://github.com/meshery/meshery) ⭐ 11,830 | 🐛 2,022 | 🌐 TypeScript | 📅 2026-09-19 is the open source, cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
...
* [Reloader](https://github.com/stakater/Reloader) ⭐ 10,419 | 🐛 165 | 🌐 Go | 📅 2026-09-18 is a Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on associated Deployments/StatefulSets/Daemonsets and Argo Rollouts.
* [Metaflow](https://github.com/Netflix/metaflow) ⭐ 10,273 | 🐛 503 | 🌐 Python | 📅 2026-09-14 is a Python library for building and managing real-life data science projects.
* [Devtron](https://github.com/devtron-labs/devtron) ⭐ 5,601 | 🐛 771 | 🌐 Go | 📅 2026-09-17 is a Web-Based CI/CD Platform for Kubernetes, powered by Argo.
...
* [Kubeflow Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,221 | 🐛 502 | 🌐 Go | 📅 2026-09-18 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
...
* [Kargo](https://github.com/akuity/kargo) ⭐ 3,668 | 🐛 213 | 🌐 Go | 📅 2026-09-18 helps GitOps practitioners streamline continuous delivery for Kubernetes by automating the progression of changes from one environment to the next.
...
* [terraform-provider-argocd](https://github.com/oboukili/terraform-provider-argocd) ⭐ 508 | 🐛 37 | 🌐 Go | 📅 2026-09-19 is the Terraform provider for Argo CD.
* [argocd-lovely-plugin](https://github.com/crumbhole/argocd-lovely-plugin) ⭐ 490 | 🐛 12 | 🌐 Go | 📅 2026-09-18 is a plugin that allows you to composite multiple things together into a single argocd application or applicationSet. Includes allowing Helm+Kustomize, addition other manifests trivially and running additional plugins in a pipe.
* [deployKF](https://github.com/deployKF/deployKF) ⭐ 467 | 🐛 65 | 🌐 Shell | 📅 2024-08-03 effortlessly integrates Kubeflow, and leading MLOps tools on Kubernetes into open ML platforms (uses Argo CD and Argo Workflows).
...
* [active-monitor](https://github.com/keikoproj/active-monitor) ⭐ 188 | 🐛 23 | 🌐 Go | 📅 2026-09-19 is a Kubernetes controller which enables deep cluster monitoring and self-healing using Argo Workflows.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 137 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-19 is an AI-powered multi-cluster Kubernetes management dashboard (CNCF Sandbox) that integrates with Argo CD for GitOps-driven workload placement and monitoring across edge and cloud clusters.
...
* [Argo CD](https://github.com/argoproj/argo-cd/blob/master/README.md#blogs-and-presentations) ⭐ 24,195 | 🐛 4,358 | 🌐 Go | 📅 2026-09-19
* [Argo Workflows](https://github.com/argoproj/argo-workflows/blob/master/README.md#community-blogs-and-presentations) ⭐ 16,992 | 🐛 1,287 | 🌐 Go | 📅 2026-09-19
...
* [Argo Events](https://github.com/argoproj/argo-events/blob/master/README.md#blogs-and-presentations) ⭐ 2,694 | 🐛 156 | 🌐 Go | 📅 2026-09-19
