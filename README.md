...
* [Argo Helm](https://github.com/argoproj/argo-helm) ⭐ 2,358 | 🐛 72 | 🌐 Mustache | 📅 2026-08-28 is a collection of community-maintained Helm charts for Argo projects.
...
* [Kubeflow Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,196 | 🐛 464 | 🌐 Python | 📅 2026-08-27 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
...
* [Kargo](https://github.com/akuity/kargo) ⭐ 3,605 | 🐛 176 | 🌐 Go | 📅 2026-08-29 helps GitOps practitioners streamline continuous delivery for Kubernetes by automating the progression of changes from one environment to the next.
