...
* [Argo Helm](https://github.com/argoproj/argo-helm) ⭐ 2,352 | 🐛 66 | 🌐 Mustache | 📅 2026-08-21 is a collection of community-maintained Helm charts for Argo projects.
* [Argo CD Image Updater](https://github.com/argoproj-labs/argocd-image-updater) ⭐ 1,710 | 🐛 309 | 🌐 Go | 📅 2026-08-18 is a tool to automatically update the container images of Kubernetes workloads which are managed by Argo CD.
* [Argo CD Autopilot](https://github.com/argoproj-labs/argocd-autopilot) ⭐ 1,125 | 🐛 97 | 🌐 Go | 📅 2025-12-16 offers an opinionated way of installing Argo CD and managing GitOps repositories.
...
* [Hera](https://github.com/argoproj-labs/hera) ⭐ 928 | 🐛 26 | 🌐 Python | 📅 2026-08-18 is an Argo Python SDK. Hera aims to make construction and submission of various Argo Project resources easy and accessible to everyone.
* [Argo CD Operator](https://github.com/argoproj-labs/argocd-operator) ⭐ 879 | 🐛 56 | 🌐 Go | 📅 2026-08-21 is a Kubernetes operator for managing Argo CD clusters.
* [Argo CD Agent](https://github.com/argoproj-labs/argocd-agent) ⭐ 579 | 🐛 60 | 🌐 Go | 📅 2026-08-20 aims to improve scalability and security of Argo CD's multi-cluster capabilities
...
* [Argo Rollout Extension](https://github.com/argoproj-labs/rollout-extension) ⭐ 287 | 🐛 36 | 🌐 TypeScript | 📅 2026-06-30 contains the Argo Rollout dashboard that can be added into the Argo CD Web UI.
* [Argo Rollouts Manager](https://github.com/argoproj-labs/argo-rollouts-manager) ⭐ 143 | 🐛 3 | 🌐 Go | 📅 2026-08-21 is a Kubernetes operator that provides an easy way to install, upgrade and manage the lifecycle of Argo Rollouts.
* [Argo CD Extensions](https://github.com/argoproj-labs/argocd-extensions) ⭐ 116 | 🐛 18 | 🌐 Go | 📅 2023-11-17 enables extensions for Argo CD.
* [Argo CD RBAC Operator](https://github.com/argoproj-labs/argocd-rbac-operator) ⭐ 110 | 🐛 19 | 🌐 Go | 📅 2026-02-20 is a Kubernetes operator for managing Argo CD's RBAC. It supports both global scoped RBAC (`argocd-rbac-cm`) and project scoped RBAC (AppProjects).
...
* [Meshery](https://github.com/meshery/meshery) ⭐ 11,544 | 🐛 1,821 | 🌐 TypeScript | 📅 2026-08-21 is the open source, cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
* [Kedro](https://github.com/quantumblacklabs/kedro) ⭐ 10,958 | 🐛 145 | 🌐 Python | 📅 2026-08-21 is an open-source Python framework for creating reproducible, maintainable and modular data science code.
* [Reloader](https://github.com/stakater/Reloader) ⭐ 10,352 | 🐛 164 | 🌐 Go | 📅 2026-08-17 is a Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on associated Deployments/StatefulSets/Daemonsets and Argo Rollouts.
* [Metaflow](https://github.com/Netflix/metaflow) ⭐ 10,228 | 🐛 481 | 🌐 Python | 📅 2026-08-20 is a Python library for building and managing real-life data science projects.
* [Devtron](https://github.com/devtron-labs/devtron) ⭐ 5,585 | 🐛 763 | 🌐 Go | 📅 2026-08-21 is a Web-Based CI/CD Platform for Kubernetes, powered by Argo.
...
* [Kubeflow Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,191 | 🐛 462 | 🌐 Python | 📅 2026-08-21 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
...
* [Kargo](https://github.com/akuity/kargo) ⭐ 3,588 | 🐛 181 | 🌐 Go | 📅 2026-08-21 helps GitOps practitioners streamline continuous delivery for Kubernetes by automating the progression of changes from one environment to the next.
...
* [Kubeflow Katib](https://github.com/kubeflow/katib) ⭐ 1,696 | 🐛 106 | 🌐 Python | 📅 2026-08-06 is a Kubernetes-native project for automated machine learning (AutoML).
...
* [kubechecks](https://github.com/zapier/kubechecks) ⭐ 607 | 🐛 13 | 🌐 Go | 📅 2026-08-20 is a tool to check what changes a pull-request will make to your ArgoCD applications, with reporting directly in the PR.
...
* [argocd-lovely-plugin](https://github.com/crumbhole/argocd-lovely-plugin) ⭐ 490 | 🐛 13 | 🌐 Go | 📅 2026-08-21 is a plugin that allows you to composite multiple things together into a single argocd application or applicationSet. Includes allowing Helm+Kustomize, addition other manifests trivially and running additional plugins in a pipe.
...
* [argonaut](https://github.com/darksworm/argonaut) ⭐ 439 | 🐛 17 | 🌐 Go | 📅 2026-08-19 is a TUI application for managing apps in Argo CD with real-time monitoring, diff viewing, and sync/rollback operations.
* [Nixidy](https://github.com/arnarg/nixidy) ⭐ 378 | 🐛 2 | 🌐 Nix | 📅 2026-08-14 is a tool to apply the rendered manifest pattern using NixOS-like modules to define Argo CD applications.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 127 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-21 is an AI-powered multi-cluster Kubernetes management dashboard (CNCF Sandbox) that integrates with Argo CD for GitOps-driven workload placement and monitoring across edge and cloud clusters.
...
* [argo-watcher](https://github.com/shini4i/argo-watcher) ⭐ 105 | 🐛 1 | 🌐 Go | 📅 2026-08-20 is a small service that improves the visibility of deployments that are using Argo CD Image Updater.
* [argo-cd-mixin](https://github.com/adinhodovic/argo-cd-mixin) ⭐ 100 | 🐛 1 | 🌐 Jsonnet | 📅 2026-08-16 is a monitoring mixin for ArgoCD. A set of Grafana dashboards and Prometheus rules for ArgoCD.
...
* [provider-argocd](https://github.com/crossplane-contrib/provider-argocd) ⭐ 99 | 🐛 19 | 🌐 Go | 📅 2026-08-21 is the Crossplane infrastructure provider for Argo CD.
* [ci-github-notifiter](https://github.com/sendible-labs/ci-github-notifier) ⭐ 51 | 🐛 9 | 🌐 Go | 📅 2026-08-19 is a lightweight container to post Argo Workflow statuses back to GitHub as [Status Checks](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/collaborating-on-repositories-with-code-quality-features/about-status-checks).
...
* [argo-trivy-insights](https://github.com/DeWildeDaan/Argo-Trivy-Insights) ⭐ 17 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-16 is a Argo CD extension to view and analyze Trivy vulnerability findings for individual Argo CD applications or across your entire GitOps fleet.
* [Juno](https://github.com/lumindigital/juno) ⭐ 12 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-20 is an Argo Workflows Generator written in Typescript. Juno helps take the pain out of writing workflows in YAML
...
* [Argo Project GitHub Organization](https://github.com/argoproj) ([Maintainers](https://github.com/argoproj/argoproj/blob/master/MAINTAINERS.md) ⭐ 753 | 🐛 26 | 🌐 Python | 📅 2026-07-17 and [Community Governance](https://github.com/argoproj/argoproj/blob/master/community/GOVERNANCE.md) ⭐ 753 | 🐛 26 | 🌐 Python | 📅 2026-07-17)
...
* Argo Project User Survey Results:
  * [2021](https://github.com/argoproj/argoproj/blob/f4daa47706c73302faba1608cbc312bbafa0abfc/community/user_surveys/Argo%20CD%20and%20Rollouts%20User%20Survey%202021.pdf) ⭐ 753 | 🐛 26 | 🌐 Python | 📅 2026-07-17
  * [2020](https://github.com/argoproj/argoproj/blob/f4daa47706c73302faba1608cbc312bbafa0abfc/community/user_surveys/ArgoWorkflows2020SurveySummary.pdf) ⭐ 753 | 🐛 26 | 🌐 Python | 📅 2026-07-17
...
Some blogposts and videos are selected from [Argo's community blogs and presentations](https://github.com/argoproj/argoproj#community-blogs-and-presentations) ⭐ 753 | 🐛 26 | 🌐 Python | 📅 2026-07-17.

Thanks to the contributors who've submitted pull requests to add the original references to the following locations:

* [Argo CD](https://github.com/argoproj/argo-cd/blob/master/README.md#blogs-and-presentations) ⭐ 23,965 | 🐛 4,395 | 🌐 Go | 📅 2026-08-21
* [Argo Workflows](https://github.com/argoproj/argo-workflows/blob/master/README.md#community-blogs-and-presentations) ⭐ 16,924 | 🐛 1,261 | 🌐 Go | 📅 2026-08-21
* [Argo Rollouts](https://github.com/argoproj/argo-rollouts/blob/master/README.md#community-blogs-and-presentations) ⭐ 3,560 | 🐛 659 | 🌐 Go | 📅 2026-08-21
* [Argo Events](https://github.com/argoproj/argo-events/blob/master/README.md#blogs-and-presentations) ⭐ 2,687 | 🐛 150 | 🌐 Go | 📅 2026-08-17
