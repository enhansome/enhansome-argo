...
* [Argo Helm](https://github.com/argoproj/argo-helm) ⭐ 2,366 | 🐛 34 | 🌐 Mustache | 📅 2026-09-11 is a collection of community-maintained Helm charts for Argo projects.
...
* [Argo CD Operator](https://github.com/argoproj-labs/argocd-operator) ⭐ 887 | 🐛 82 | 🌐 Go | 📅 2026-09-09 is a Kubernetes operator for managing Argo CD clusters.
* [Argo CD Agent](https://github.com/argoproj-labs/argocd-agent) ⭐ 589 | 🐛 65 | 🌐 Go | 📅 2026-09-10 aims to improve scalability and security of Argo CD's multi-cluster capabilities
...
* [Meshery](https://github.com/meshery/meshery) ⭐ 11,752 | 🐛 1,979 | 🌐 TypeScript | 📅 2026-09-11 is the open source, cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
...
* [Reloader](https://github.com/stakater/Reloader) ⭐ 10,405 | 🐛 161 | 🌐 Go | 📅 2026-09-09 is a Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on associated Deployments/StatefulSets/Daemonsets and Argo Rollouts.
...
* [Devtron](https://github.com/devtron-labs/devtron) ⭐ 5,595 | 🐛 777 | 🌐 Go | 📅 2026-09-11 is a Web-Based CI/CD Platform for Kubernetes, powered by Argo.
...
* [Kubeflow Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,210 | 🐛 485 | 🌐 Go | 📅 2026-09-10 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
...
* [Kargo](https://github.com/akuity/kargo) ⭐ 3,652 | 🐛 200 | 🌐 Go | 📅 2026-09-11 helps GitOps practitioners streamline continuous delivery for Kubernetes by automating the progression of changes from one environment to the next.
...
* [terraform-provider-argocd](https://github.com/oboukili/terraform-provider-argocd) ⭐ 508 | 🐛 36 | 🌐 Go | 📅 2026-09-11 is the Terraform provider for Argo CD.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 133 | 🐛 149 | 🌐 TypeScript | 📅 2026-09-11 is an AI-powered multi-cluster Kubernetes management dashboard (CNCF Sandbox) that integrates with Argo CD for GitOps-driven workload placement and monitoring across edge and cloud clusters.
...
* [argo-watcher](https://github.com/shini4i/argo-watcher) ⭐ 108 | 🐛 3 | 🌐 Go | 📅 2026-09-11 is a small service that improves the visibility of deployments that are using Argo CD Image Updater.
...
* [provider-argocd](https://github.com/crossplane-contrib/provider-argocd) ⭐ 99 | 🐛 15 | 🌐 Go | 📅 2026-09-11 is the Crossplane infrastructure provider for Argo CD.
...
* [Argo CD](https://github.com/argoproj/argo-cd/blob/master/README.md#blogs-and-presentations) ⭐ 24,135 | 🐛 4,362 | 🌐 Go | 📅 2026-09-11
* [Argo Workflows](https://github.com/argoproj/argo-workflows/blob/master/README.md#community-blogs-and-presentations) ⭐ 16,968 | 🐛 1,288 | 🌐 Go | 📅 2026-09-11
...
* [Argo Events](https://github.com/argoproj/argo-events/blob/master/README.md#blogs-and-presentations) ⭐ 2,691 | 🐛 154 | 🌐 Go | 📅 2026-09-05
